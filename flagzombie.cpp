...
FlagZombie::FlagZombie()    //Default constructor
{
    width = 48;
    height = 61;
    life = 10;
    ...
    speed = 0.2;
    speedIsSlower = false;
    objectType = "FlagZombie";
    imageUrl = ":/images/flag-zombie.gif";  //File location of the flag zombie gif
    imageUrlWidth = 48;                     //Image width
    imageUrlHeight = 61;                    //Image height
...
FlagZombie::~FlagZombie()   //Destructor
{}

void FlagZombie::setupGameObject()  //Setup and initialize game object
{
