...
int SnowPea::cost = 175;

SnowPea::SnowPea(QObject *)  //Default constructor
{
    width = 72;
    height = 71;
    life = 4;
    ...
    itemCost = 175;
    objectType = "SnowPea";
    imageUrl = ":/images/snow-pea.gif"; //File path of the snow pea gif
...
void SnowPea::fireBullet()
{
    ...
    for (int i = 0; i < MainWindow::zombieObjects.size(); i++)
    {
        ...
        {
            //Create a new bullet
            GameObject *bullet = new SnowPeaBullet();
